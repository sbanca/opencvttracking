...
pipelinesList['exclRect'] = pipeline()
pipelinesList['exclRect'].config(flip=True,Trim=True,renderExclRect=True,BGR2RGB=True)
...
pipelinesList['syncEyetrack'].config(prepearEyeGaze=False,undistortCamera=True,Trim2=True,drawEyeGaze=False,BGR2RGB=True,)
